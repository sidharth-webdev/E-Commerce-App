...
export function Fakestore() {
  ...
  const [products, setProducts] = useState([
    { id: 0, title: '', price: 0, category: '', description: '', image: '', rating: { rate: 0, count: 0 } }
  ]);
      ...
      <header className="d-flex bg-light justify-content-between p-2 mt-3">
        ...
        <div>
          <button data-bs-toggle="modal" data-bs-target="#cart" className="btn bi bi-cart4 position-relative">
            <span className="badge bg-danger position-absolute rounded rounded-circle">{cartItems.length}</span>
          </button>
